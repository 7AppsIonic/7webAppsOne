...
import asia.titanium.pa.adapter.PageCheckListAdapter;
...
//                            ApplicationSettings.setFirstRun(WizardModalActivity.this, false);
                            ...
                            getPackageManager().setComponentEnabledSetting(
                                    new ComponentName("asia.titanium.pa", "asia.titanium.pa.HomeActivity-calculator"),
                                    PackageManager.COMPONENT_ENABLED_STATE_ENABLED, PackageManager.DONT_KILL_APP);

                            getPackageManager().setComponentEnabledSetting(
                                    new ComponentName("asia.titanium.pa", "asia.titanium.pa.HomeActivity-setup"),
